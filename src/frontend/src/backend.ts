...
export class Backend implements backendInterface {
    ...
    async addPhotocard(arg0: string, arg1: string, arg2: ExternalBlob, arg3: CardPosition, arg4: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotocard(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBinder(arg0: string, arg1: BinderTheme): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createBinder(arg0, to_candid_BinderTheme_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBinderTheme(arg0: string, arg1: BinderTheme): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBinderTheme(arg0, to_candid_BinderTheme_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_BinderView_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BinderView): Promise<BinderView> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        theme: from_candid_BinderTheme_n16(_uploadFile, _downloadFile, value.theme),
        created: value.created,
        cards: await from_candid_vec_n19(_uploadFile, _downloadFile, value.cards),
        name: value.name
    };
}
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverTexture: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.coverTexture)),
        borderStyle: value.borderStyle,
        accentColor: value.accentColor,
        backgroundPattern: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.backgroundPattern)),
...
function from_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        displayName: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.displayName)),
        name: value.name,
...
async function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Photocard>): Promise<Array<Photocard>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Photocard_n20(_uploadFile, _downloadFile, x)));
}
function to_candid_BinderTheme_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BinderTheme): _BinderTheme {
